...
import (
	...
	"github.com/suhostersky/bitget/logging/applogger"
...
func (p *BitgetBaseWsClient) Init(secretKey string) *BitgetBaseWsClient {
	p.Connection = false
...
func (p *BitgetBaseWsClient) Login(apiKey, passphrase string) {
	timesStamp := types.TimesStampSec()
